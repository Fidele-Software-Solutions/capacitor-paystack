...
@implementation PSTCKFormTextField

@synthesize placeholderColor = _placeholderColor;

- (void)setFormDelegate:(id<PSTCKFormTextFieldDelegate>)formDelegate {
...
- (NSAttributedString *)attributedStringForString:(NSString *)string attributes:(NSDictionary *)attributes {
    ...
    if (self.formatsCardNumbers && [PSTCKCardValidator stringIsNumeric:string]) {
        NSArray *cardSpacing;
